...
//   updateStateFromUrl = () => {
//     const { location, setViewport, showMachine, showTag, showOperation } = this.props;
//     let matchResult;
...
//       if (matchResult.viewport === 'machines') {
//         showMachine(decodeURI(matchResult.objectId));
//       } else if (matchResult.viewport === 'tags') {
//         showTag(decodeURI(matchResult.objectId));
//       } else if (matchResult.viewport === 'operations') {
//         showOperation(decodeURI(matchResult.objectId));
//       }
//       return;
//     }
//
...
//
//   updateUrlFromState = () => {
//     const { viewport, currentMachineId, currentTagId, currentOperationId, location, push } = this.props;
//     let expectedUrl;
//
...
//   const currentMachineId = getCurrentMachineId(state);
//   const currentTagId = getCurrentTagName(state);
//   const currentOperationId = getCurrentOperationId(state);
...
//     showMachine: showMachineAction,
//     showTag: showTagAction,
//     showOperation: showOperationAction,
//   },
// )(URLSync);
//
